...
class AchievementHandler {
    ...
    handleSmallAchievements() {
        ...
        if (Date.now() - this.lastPromptTime < 2000)
            return;
        ...
        if (!Game.AchievementsById[ACHIEVEMENT_IDS.GOD_COMPLEX].won) {
            if (Game.promptOn)
                return; // Wait for any existing prompt
...
class AutoPlay_AutoPlay {
    ...
    runJustRight() {
        ...
        if (this.Config.CheatGolden > 0)
            this.Config.CheatGolden = 0;
        if (this.Config.CheatLumps > 0)
            this.Config.CheatLumps = 0;
        if (this.config.autoGoldenCookie)
            this.config.autoGoldenCookie = false;
        if (this.config.autoReindeer)
            this.config.autoReindeer = false;
        if (this.Config.ClickMode !== 0)
            this.Config.ClickMode = 0;
...
// Version
AutoPlay_AutoPlay.version = '2.052-127';
...
/******/ })()
;
//# sourceMappingURL=cookieAutoPlayBeta-v2.052-127.js.map