            ...
            if (achievement.threshold) {
                ...
                if (numMatch) {
                    ...
                    if (valueStr.toLowerCase().includes('million'))
                        cookieThreshold *= 1000000;
                    else if (valueStr.toLowerCase().includes('billion'))
                        cookieThreshold *= 1000000000;
                    else if (valueStr.toLowerCase().includes('trillion'))
                        cookieThreshold *= 1000000000000;
                    else if (valueStr.toLowerCase().includes('quadrillion'))
                        cookieThreshold *= 1000000000000000;
                    else if (valueStr.toLowerCase().includes('quintillion'))
                        cookieThreshold *= 1000000000000000000;
                }
            }
