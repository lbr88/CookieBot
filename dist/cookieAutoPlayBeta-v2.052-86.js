    ...
    updateModuleColumns() {
        ...
        try {
            ...
            if (miniModulesContainer) {
                // Take first 4 modules but only show active ones to save space
                const interestingModules = allModules.slice(0, 4).filter(m => m.status.status !== 'idle');
...
// Version
AutoPlay_AutoPlay.version = '2.052-86';
