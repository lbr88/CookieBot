...
class Dashboard {
    ...
    `;
        ...
        miniModules.style.cssText = 'display: none; padding: 4px 16px; gap: 16px; align-items: center; background: rgba(0, 0, 0, 0.2); min-height: 24px; overflow: hidden; white-space: nowrap;';
    ...
    `;
        ...
        dashboard.appendChild(miniModules);
...
// Version
AutoPlay_AutoPlay.version = '2.052-82';
