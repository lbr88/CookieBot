...
AutoPlay.createDashboard = function() {
  ...
  dashboard.style.cssText = 'position: fixed; bottom: 60px; left: 0; right: 0; background: rgba(0, 0, 0, 0.9); border-top: 2px solid #6f6; z-index: 10000; transition: transform 0.3s ease;';
